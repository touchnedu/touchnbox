! function(a) {
    "use strict";
    $('.sy-caption > a > img').click(function(event) {
    ...
    b = {
        ...
        return e = this, 0 === e.length ? this : e.length > 1 ? (e.each(function() {
            ...
            }), d.vars.count > 1 || d.settings.initSingle ? (-1 === a("." + d.settings.activeClass, e).index() ? (f = "random" === d.settings.start ? Math.round(Math.random() * (d.vars.count - 1)) : d.settings.start > 0 && d.settings.start <= d.vars.count ? d.settings.start - 1 : 0, d.vars.active = a(d.vars.slides[f]).addClass(d.settings.activeClass)) : d.vars.active = a("." + d.settings.activeClass, e), j(), o(), x(d.vars.slides), void 0) : this
        }, h(), this)
    }
}(jQuery);